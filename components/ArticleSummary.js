...
const ArticleSummary = ({ reversed }) => {
  return (
     <>
      <div className={`flex  m-4 flex-col pw-auto md:${reversed? "flex-col-reverse":"flex-row"}  justify-center   `}>
        <div className={`m-auto  mt-4 mb-4   pw-auto flex  xl:justify-start 2xl:justify-center items-center`}>
          <Image src="/books.jpg" alt="books" width={400} height={400} />
        </div>
        <div className={`p-8 m-auto   border-primary-color border-b-4 md:border-l-4 md:border-b-0 md:w-1/2 md:m-2  'order-first sm:order-last'  `}>
