...
const AboutUs = () => {
  ...
  return (
    ...
    <p className="w-1/2 mx-auto mt-3">sdjog  sdlgijsag lafdsal alsihjal gslighwli glis ligjli lisvia  
    ...
    <div className="bio-grid w-full grid bg-primary-color-20  gap-4 p-4">
